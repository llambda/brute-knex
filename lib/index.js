        ...
        this.ready = this.knex.schema.hasTable(this.options.tablename)
            .then((exists) => {
                ...
                return this.knex.schema.createTable(this.options.tablename, (table) => {
                    table.string('key');
                    table.timestamp('firstRequest').defaultTo(this.knex.fn.now());
                    table.timestamp('lastRequest').defaultTo(this.knex.fn.now());
                    table.timestamp('lifetime').defaultTo(this.knex.fn.now());
                    table.integer('count');
                });
            });
    }
